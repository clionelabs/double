...
Customer = {
  ...
  creditFromSubscription(from, to) {
    ...
    let creditMs = _.reduce(mySubscriptions, function(memo, subscription) {
      ...
      const subscriptionRatio = subscription.ratio(from, to);
      const ratioFromSubscription = (subscriptionRatio ? subscriptionRatio.ratio : 0);
      return memo + ratioFromSubscription * plan.freeCreditMs;
    }, 0);
    return creditMs;
  },
  creditMs() {
